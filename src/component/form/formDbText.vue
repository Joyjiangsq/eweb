<template>
    <div :class="[css.formOne, classname, vertical?css.verticalitem:'']">
        ...
        <div :class="css.formtarget">
            <input :type="inputtype" style="width: 25%;" :class="unit?css.unitStay:''" @blur="blurHandler" name="name1" :value1="value1" v-model="value1" :placeholder="placeholder" :disabled="read" @keydown="keyDownHandler"  @focus="focusHandler">
            <input :type="inputtype" style="width: 25%;" :class="unit?css.unitStay:''" @blur="blurHandler" name="name2" :value2="value2" v-model="value2" :placeholder="placeholder" :disabled="read" @keydown="keyDownHandler"  @focus="focusHandler">
