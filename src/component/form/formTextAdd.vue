extext<template>
    <div :class="[css.formOne, classname, vertical?css.verticalitem:'']">
        ...
        <div :class="css.formtarget">
            <input :type="inputtype" :class="unit?css.unitStay:''" style="width: 400px;" @blur="blurHandler" name="name" :value="value" v-model="value" :placeholder="placeholder" :disabled="read" @keydown="keyDownHandler" @focus="focusHandler">
