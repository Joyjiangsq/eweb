...
export default {
  ...
  data: function () {
    return {
      ...
      recData:{},
      testData: [{ItemCode:"xxx01ww", ItemName:"大卫地板", buyCounts:{}, useStores:{}, avalibleStores:20, SWW:"主材包", FirmName:"这是二级分类", U_ThreeL:"这是三级分类", U_Brand:"这是品牌哦", U_CardName:"供应商大卫", U_Modle:"031x33",U_Series:"xxwoo",U_MQuality:"金w子",SalUnitMsr:"个w", Spec:"哦w，哦，哦，"}],
