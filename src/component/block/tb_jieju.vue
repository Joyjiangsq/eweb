    ...
    <div class="">
          ...
          <dialog :flag="showSelectDialog" title="选品" >
                <div slot="containerDialog">
                      <jiejulist :hash="false" :toload="toload" @addone="addoneHandler" @deleteone="deleteoneHandler" :listdata.sync="vlist"></jiejulist>
                </div>
...
export default {
  ...
  components: {formtext, cascadeform, jiejulist},
}
</script>
