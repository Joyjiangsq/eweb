    ...
    <div class="">
          ...
          <dialog :flag="showSelectDialog" title="选品" >
                <div slot="containerDialog">
                      <shigongfucailist :hash="false" @addone="addoneHandler" @deleteone="deleteoneHandler" :listdata.sync="testData"></shigongfucailist>
                </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      recData:{},
      testData: [{ItemCode:"xxx01ww", ItemName:"施工辅材", buyCounts:{}, avalibleStores:20, SWW:"主材包", FirmName:"这是二级分类", U_ThreeL:"这是三级分类", U_Brand:"这是品牌哦", U_CardName:"施工辅材", U_Modle:"031x33",U_Series:"xxwoo",U_MQuality:"金w子",SalUnitMsr:"个w", Spec:"哦w，哦，哦，"}],
