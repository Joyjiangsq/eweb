  ...
  data: function () {
    return {
      ...
      headercaption:[{type:"operator", name:""},
                    ...
                    {name:"产品名称", labelValue:"ItemNameComponent", type:"componentspec", cname:"chuguicc", component:mdialog},
                    ...
                    {name:"延米（m）/采购数量", labelValue:"U_Pquantity", type:"edit", number: true},
      ...
      headerdetail:[
                    ...
                    {name:"延米采购数量", labelValue:"U_Pquantity", type:"data", number: true},
                    {name:"转换数量", labelValue:"Quantity", type:"data"},
                    {name:"包装数量", labelValue:"SalPackUn",type:"data"},
                    {name:"包装单位", labelValue:"SalPackMsr",type:"data"},
                    {name:"单位", labelValue:"SalUnitMsr",type:"data"},
