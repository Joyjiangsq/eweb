  ...
  data: function () {
    return {
      ...
      headercaption:[{type:"operator", name:""},
                    ...
                    {name:"智能门锁厚度（mm）", labelValue:"U_DThick", type:"edit", style:{width: '100px'}},
                    {name:"智能门锁锁体挡板长度（mm）（mm）", labelValue:"U_LBLength", type:"edit", style:{width: '100px'}},
      ...
      headerdetail:[{name:"产品编码", labelValue:"ItemCode", type:"data"},
                    ...
                    {name:"采购数量", labelValue:"U_Pquantity", type:"data", number: true},
                    {name:"转换数量", labelValue:"Quantity", type:"data"},
                    {name:"包装数量", labelValue:"SalPackUn",type:"data"},
                    {name:"包装单位", labelValue:"SalPackMsr",type:"data"},
                    {name:"单位", labelValue:"SalUnitMsr",type:"data"},
