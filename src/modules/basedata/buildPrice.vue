        ...
        <dialog :flag.sync="flagdep" @dialogclick="diaologClick" :title="optitle">
              <div class="" slot="containerDialog">
                <div class="" v-if="hideDialogIn">
                  <formtext labelname="最小面积：" :value.sync="addParams.CardName"  placeholder="请输入名称" :vertical="true" formname='CardName' :validatestart="validate" @onvalidate="validateHandler"></formtext>
                  <formtext labelname="最大面积：" :value.sync="addParams.CardName"  placeholder="请输入联系人" :vertical="true" formname='CardName' :validatestart="validate" @onvalidate="validateHandler"></formtext>
                  <formtext labelname="卫生间数：" :value.sync="addParams.phone"  placeholder="请输入电话" :vertical="true" :phone="true" formname='phone'  :validatestart="validate" @onvalidate="validateHandler"></formtext>
                  <formtext labelname="一口价：" :value.sync="addParams.phone"   placeholder="备注" :vertical="true" formname='phone'  :validatestart="validate" @onvalidate="validateHandler"></formtext>
                </div>
              </div>
        </dialog>
        <!--删除提示-->
...
let tableHeaderDatas = [{name:"最小面积", labelValue:"CardCode", type:"data"},
                        {name:"最大面积", labelValue:"CardName",type:"data"},
                        {name:"卫生间数", labelValue:"roles",type:"data"},
                        {name:"一口价", labelValue:"phone",type:"data"},
