<template lang="html">
    <div >
      <cascadeform  labelname="客户地址：" :must="false"  :detailneed="true" :value.sync= "data.Address" :detail.sync="data.detail" formname="Address" :vertical="true" :validatestart="formControl.validate" @onvalidate="formControl.validateHandler"></cascadeform>
